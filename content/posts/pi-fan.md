...
I spent most of the day writing software to connect a single fan to a single temperature sensor
...
in this situation passive cooling can't keep up with the heat being generated by the computer,
...
you can plug into a model the exact fan speed that would keep the PC below the danger temperature.
...
always having the lowest possible RPM would be annoying because the pitch of the hum would change all the time
