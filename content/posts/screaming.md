...
(screaming) is read as a screenplay parenthetical.
...
You don't need to bookmark it. The first five letters can be typed with only the left hand.
The rest of the URL autocompletes
without ever moving your right hand from the mouse.

# Development

It looks like it could have been done with a single AI prompt.
The first 90% was a single AI prompt.
The [second 90%](https://wikipedia.org/wiki/Ninety–ninety_rule) was all me.
